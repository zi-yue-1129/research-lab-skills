...
is `tests/<group>/test_*.py` per spec §13 step 9 path-mapping rule. CI uses
`python -m unittest tests.<group>.test_*`.

Run:
    python -m unittest tests.audit.test_claim_audit_calibration -v
"""
