...
convention places tests under `tests/<group>/test_*.py` (CI uses
`python -m unittest tests.<group>.test_*`); the spec-named stem is preserved.

Run:
    python -m unittest tests.audit.test_claim_intent_manifest -v
"""
