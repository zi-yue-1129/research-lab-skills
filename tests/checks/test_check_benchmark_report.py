...
SCRIPT = Path(__file__).resolve().parents[2] / "scripts" / "checks" / "check_benchmark_report.py"
SCHEMA = Path(__file__).resolve().parents[2] / "shared" / "schemas" / "benchmark_report.schema.json"
