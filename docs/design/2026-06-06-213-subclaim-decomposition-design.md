...
| Tests | `tests/audit/test_claim_audit_schema.py`, `scripts/test_claim_audit_consistency*.py` | Positive (valid breakdown), negative (breakdown on SUPPORTED row fails INV-19), mutation (accept-all guard) |
