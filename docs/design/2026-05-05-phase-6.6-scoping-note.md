...
In `tests/checks/test_check_v3_6_7_pattern_protection.py` (or a new sibling test file):
...
Run: `pytest tests/tooling/test_v3_6_7_phase_6_6.py -v` → all four tests must FAIL before implementation.
...
`python3 scripts/check_spec_consistency.py` and `pytest tests/tooling/test_v3_6_7_phase_6_6.py` must pass; line count ≤639.
