...
#### L1.2 — Protocol doc: `shared/protocols/intent_clarification_protocol.md` (NEW file)
...
```markdown
> **Routing discipline:** see `.claude/CLAUDE.md` "Routing Discipline (v3.9.2)" + `shared/protocols/intent_clarification_protocol.md`. This skill assumes routing has already settled.
```
