...
- `shared/schemas/sprint_contract.schema.json` — Schema 13
...
## 3. Schema 13 — `shared/schemas/sprint_contract.schema.json`
...
```
shared/schemas/sprint_contract.schema.json
shared/contracts/README.md
...
- `shared/schemas/compliance_report.schema.json`, `shared/protocols/compliance_checkpoint_protocol.md`, `shared/protocols/cross_model_verification.md`.
...
- `shared/schemas/compliance_report.schema.json` (Schema 12, pattern source)
- `scripts/check_compliance_report.py` (validator pattern source)
- `tests/test_check_compliance_report.py` (test pattern source)
- `shared/protocols/compliance_checkpoint_protocol.md` (protocol-doc pattern source)
