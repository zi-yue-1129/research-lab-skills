...
Usage:
    python scripts/tooling/generate_slides.py --data slide_data.json --out ./output/
    python scripts/tooling/generate_slides.py --data slide_data.json --out ./output/ --slide 5
