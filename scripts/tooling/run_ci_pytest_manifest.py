...
Local use:
    python scripts/tooling/run_ci_pytest_manifest.py            # run everything
    python scripts/tooling/run_ci_pytest_manifest.py --id <id>  # run one entry

The drift guard at scripts/checks/check_ci_pytest_manifest.py validates the manifest
