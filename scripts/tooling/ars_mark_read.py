...
Usage:
    python3 scripts/tooling/ars_mark_read.py <citation_key>... --passport-path <path>
    python3 scripts/tooling/ars_mark_read.py <citation_key>... --passport-path <path> --unmark
