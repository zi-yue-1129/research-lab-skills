...
migration tool first — see scripts/migrations/migrate_literature_corpus_to_v3_7_3.py.
...
try:
    from scripts.audit._passport_yaml import dump_passport, load_passport
except ImportError:
    from scripts.audit._passport_yaml import dump_passport, load_passport
