...
Usage:
    ...
    python scripts/checks/check_literature_corpus_schema.py --passport PATH
        Validate one passport YAML only.

    python scripts/checks/check_literature_corpus_schema.py --rejection-log PATH
...
try:
    from scripts.checks.check_v3_10_policy import assert_venue_type_source_clean
except ImportError:
    from scripts.checks.check_v3_10_policy import assert_venue_type_source_clean
