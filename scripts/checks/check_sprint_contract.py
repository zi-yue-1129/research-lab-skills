...
Usage: python scripts/checks/check_sprint_contract.py path/to/contract.json [--ars-version vX.Y.Z]
...
SCHEMA_PATH = Path(__file__).resolve().parents[2] / "shared" / "schemas" / "sprint_contract.schema.json"
