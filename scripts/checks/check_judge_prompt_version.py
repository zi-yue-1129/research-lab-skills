...
`JUDGE_PROMPT_SHA256` in `scripts/audit/_claim_audit_constants.py`. On drift it fails,
...
Usage:
    python scripts/checks/check_judge_prompt_version.py
    python scripts/checks/check_judge_prompt_version.py --root PATH   (for test fixtures)
...
_CONSTANTS_REL = "scripts/audit/_claim_audit_constants.py"
...
def check(root: Path) -> int:
    ...
    if actual != pinned:
        print(
            ...
            "Fix: in scripts/audit/_claim_audit_constants.py, set JUDGE_PROMPT_SHA256 to "
