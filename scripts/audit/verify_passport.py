...
def _real_clients() -> dict:
    ...
    Dual-path import: under `python -m scripts.audit.verify_passport` the repo root is
    ...
    try:
        ...
        from scripts.clients.semantic_scholar_client import SemanticScholarClient
