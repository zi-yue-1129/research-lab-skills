...
# Share the true-partial content gate with the lint + runtime (single source
# of truth in _claim_audit_constants).
from scripts.audit._claim_audit_constants import is_true_partial_breakdown

# Constraint id shape per spec §3.2 canonical parse rule (RE_NC_CONSTRAINT
# + RE_MNC_CONSTRAINT in scripts/audit/_claim_audit_constants.py).
#
