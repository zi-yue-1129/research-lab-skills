...
# Allow both CLI invocations (`python3 scripts/audit/claim_audit_pipeline.py`) AND
...
from scripts.audit._claim_audit_constants import (  # noqa: E402
    DRIFT_RULE_VERSION,
...
def run_audit_pipeline(
    *,
    ...
    (`scripts/audit/uncited_assertion_detector.py`, §"Uncited-assertion detector
